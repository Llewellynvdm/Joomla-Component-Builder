...
/** @var \VDM\Component\Componentbuilder\Administrator\View\Joomla_plugin_files_folders_urls\HtmlView $this */

$icon = 'icon-check';
$title_key = $this->item->id ?? '';
$title_column = $this->item->name ?? '';
$data = [
	'contentType' => 'com_componentbuilder.joomla_plugin_files_folders_urls',
	'id' => $title_key,
	'title' => $title_column,
